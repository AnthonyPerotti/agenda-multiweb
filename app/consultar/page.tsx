  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg-primary)" }}>
      ...
      <header className="no-print" style={{
        ...
        <div style={{ width: "100%", maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          <button onClick={() => router.push("/")} style={{ display: "flex", alignItems: "center", gap: 10, background: "none", border: "none", cursor: "pointer", flexShrink: 0 }}>
          ...
          <span style={{ color: "#64748b", fontSize: 13, marginLeft: "auto" }}>CTE – UFSM</span>
        </div>
      </header>
